...
- `4.0`: `Greedy_LocalSearch_CPP` is practical winner in 5/10 condition groups.
...
- `tiny`: `Greedy_LocalSearch_CPP` is practical winner in 1/2 condition groups.

## Winners by distribution
- `sample`: `Greedy_LocalSearch_CPP` is practical winner in 5/10 condition groups.
