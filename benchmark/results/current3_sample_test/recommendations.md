...
- `4.0`: `Greedy_LocalSearch_CPP` is practical winner in 8/10 condition groups.

## Winners by size_group
- `large`: `Greedy_LocalSearch_CPP` is practical winner in 2/2 condition groups.
- `medium`: `Greedy_LocalSearch_CPP` is practical winner in 1/1 condition groups.
- `stress`: `Greedy_LocalSearch_CPP` is practical winner in 5/5 condition groups.
- `tiny`: `SA_Algo` is practical winner in 2/2 condition groups.

## Winners by distribution
- `sample`: `Greedy_LocalSearch_CPP` is practical winner in 8/10 condition groups.
